<template>
	...
	>
		...
		<div class="drawer-content">
			...
			<p>Выберите оформление, которое вам нравится</p>
			<hr>
			<div class="sidebar-color">
				<h6>Цвета левой навигации (Sidebar)</h6>
			...
			<div class="sidenav-type">
				<h6>Тип навигации</h6>
				<p>Выберите один из 2 типов боковой навигации.</p>
				<a-radio-group button-style="solid" v-model="sidebarThemeModel" @change="$emit('updateSidebarTheme', $event.target.value)" defaultValue="primary">
					<a-radio-button value="light">ПРОЗРАЧНЫЙ</a-radio-button>
					<a-radio-button value="white">БЕЛЫЙ</a-radio-button>
				</a-radio-group>
			</div>
			<div class="navbar-fixed">
				<h6>Верхнее меню зафиксировано</h6>
				<a-switch default-checked v-model="navbarFixedModel" @change="$emit('toggleNavbarPosition', navbarFixedModel)" />
			</div>
			<div class="download">
				<a-button type="secondary" href="#" block>ПЕРЕЙТИ НА ГЛАВНУЮ</a-button>
			</div>
